...
std::string generate_vertex_shader(const VSUid& uid) {
  ...
  o.w("  uint4 blend_indices : BLENDINDICES, uint4 blend_indices2 : BLENDINDICES1, uint texmtx7 : BLENDINDICES2) {\n");
  o.w("VS_OUTPUT o;\n");
      ...
      default: {
        if (components & (VB_HAS_TEXMTXIDX0 << i)) {
          o.w("int tmp = int(%s);\n", i < 4 ? (i == 0 ? "blend_indices.y" : i == 1 ? "blend_indices.z" : i == 2 ? "blend_indices.w" : "blend_indices2.x")
                                          : (i == 4 ? "blend_indices2.y" : i == 5 ? "blend_indices2.z" : i == 6 ? "blend_indices2.w" : "texmtx7"));
